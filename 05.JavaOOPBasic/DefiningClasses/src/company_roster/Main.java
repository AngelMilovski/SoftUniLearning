    ...
    public static void main(String[] args) throws IOException {
        ...
        employeeList.stream()
                ...
                .forEach(depart -> {
                    ...
                    sb.append(String.format("Highest Average Salary: %s", depart.getKey())).append(System.lineSeparator());
                    depart.getValue().stream()
                            .sorted((a1, a2) -> Double.compare(a2.getSalary(), a1.getSalary()))
                            .forEach(emp -> {
